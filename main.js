document.addEventListener("DOMContentLoaded", function () {
  ...
  eng.addEventListener("click", function (event) {
    ...
    secondpar.textContent =
      "My name is Todor Milivojević, I am 24 years old, and I have been involved in photography for ten years now. I focus on photographing music festivals and events, but at the same time, I capture various subjects. ";
